    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @endcan
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('my-attendances.index')" :active="request()->routeIs('my-attendances.*')">
                        {{ __('My Attendance Log') }}
                    </x-nav-link>
                </div>
                @if (Auth::user()->can('viewAny', \App\Models\User::class) && Auth::user()->can('viewAny', \App\Models\Attendance::class))
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
